...
n_rlze = 3; %number of simulated time steps
...
nu_upper_initial = mean(results.nu_upper, 2);
nu_lower_initial = mean(results.nu_lower, 2);
results_naive = stochastic_solver_avg(benchmark, ...
    ...
    %%
results_optimal = stochastic_solver_avg(benchmark, ...
    results.first_stage_out(end), nu_lower_initial, ...
    nu_upper_initial, random_vars3, params, v_bounds_tight, ...
